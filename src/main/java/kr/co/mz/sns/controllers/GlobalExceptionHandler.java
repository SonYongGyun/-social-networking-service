...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> handleInvalidPathVariableException(InvalidPathVariableFormatException ipvfe) {
        ErrorDto errorDto = new ErrorDto(ipvfe.getMessage());
